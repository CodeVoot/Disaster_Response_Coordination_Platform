...
**Prerequisites:** Node.js (v18+) and PostgreSQL with **PostGIS** enabled. And, use the init.sql file to insert the dummy data into the database to get the things on the track.
...
7. **Tradeoffs and Simplification**
